...
const ConferenceEvent = () => {
    ...
    const handleMealSelection = (index) => {
      ...
      if(item.selected && item.type === "mealForPeople"){
        const newNumberOffPeople = item.selected ? numberOfPeople :0;
        dispatch(toggleMealSelection(index, newNumberOffPeople));
      }else{
        ...
        <div className="total_cost">Total Cost: ${venueTotalCost}</div>
                            ...
                            <div id="meals" className="venue_container container_main">
                                ...
                                <div className="input-container venue_selection">
                                  <label htmlFor="numberOffPeople">
                                    <h3>Number Of People</h3>
                                  </label>
                                  <input type="number" name="numberOfPeople" id="numberOfPeople" className="input_box5"
